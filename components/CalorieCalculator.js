 ...
 *
 * 数据校准原则:
 * 1. 营养成分主要参考《中国食物成分表(第6版)》及USDA数据库。
 * 2. 热量单位为千卡 (kcal) / 100g 可食部。
 * 3. 大部分食材为常见【烹饪后】或【可直接食用】的状态，更贴近用户实际称重场景。
 * 4. 新增 "fiber" (膳食纤维) 字段。
 */
const foodDatabase = {
    主食: [
        { id: 1, name: '糙米饭(熟)', emoji: '🍚', calories: 121, protein: 2.7, carbs: 25.8, fat: 0.9, fiber: 1.8, price: 0.4, primaryUnit: 'g', defaultQuantity: 150, servingSize: 100, units: [{name: 'g', rate: 1}, {name: '碗', rate: 150}] },
        { id: 2, name: '白米饭(熟)', emoji: '🍙', calories: 116, protein: 2.6, carbs: 25.9, fat: 0.3, fiber: 0.3, price: 0.3, primaryUnit: 'g', defaultQuantity: 150, servingSize: 100, units: [{name: 'g', rate: 1}, {name: '碗', rate: 150}] },
        { id: 3, name: '藜麦饭(熟)', emoji: '🌾', calories: 120, protein: 4.4, carbs: 21.3, fat: 1.9, fiber: 2.8, price: 2.5, primaryUnit: 'g', defaultQuantity: 100, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 4, name: '全麦面包', emoji: '🍞', calories: 246, protein: 13, carbs: 41, fat: 3.4, fiber: 6, price: 1.5, primaryUnit: '片', defaultQuantity: 1, servingSize: 35, units: [{name: '片', rate: 35}, {name: 'g', rate: 1}] },
        { id: 5, name: '燕麦片(生)', emoji: '🥣', calories: 376, protein: 12.8, carbs: 69.1, fat: 7.0, fiber: 10.3, price: 1.2, primaryUnit: 'g', defaultQuantity: 50, servingSize: 100, units: [{name: 'g', rate: 1}, {name: '勺', rate: 15}] },
        { id: 6, name: '紫薯(蒸)', emoji: '🍠', calories: 102, protein: 1.8, carbs: 22.8, fat: 0.2, fiber: 3.1, price: 0.6, primaryUnit: '个', defaultQuantity: 1, servingSize: 150, units: [{name: '个', rate: 150}, {name: 'g', rate: 1}] },
        { id: 7, name: '红薯(蒸)', emoji: '🍠', calories: 86, protein: 1.6, carbs: 20.1, fat: 0.2, fiber: 2.2, price: 0.5, primaryUnit: '个', defaultQuantity: 1, servingSize: 150, units: [{name: '个', rate: 150}, {name: 'g', rate: 1}] },
        { id: 8, name: '玉米(熟)', emoji: '🌽', calories: 106, protein: 3.5, carbs: 23.5, fat: 1.3, fiber: 2.7, price: 0.8, primaryUnit: '根', defaultQuantity: 1, servingSize: 200, units: [{name: '根', rate: 200}, {name: 'g', rate: 1}] },
        { id: 9, name: '土豆(蒸)', emoji: '🥔', calories: 77, protein: 2.0, carbs: 17.5, fat: 0.1, fiber: 2.2, price: 0.4, primaryUnit: '个', defaultQuantity: 1, servingSize: 150, units: [{name: '个', rate: 150}, {name: 'g', rate: 1}] },
        { id: 10, name: '意大利面(熟)', emoji: '🍝', calories: 158, protein: 5.8, carbs: 30.9, fat: 1.0, fiber: 1.8, price: 1.8, primaryUnit: 'g', defaultQuantity: 150, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 11, name: '荞麦面(熟)', emoji: '🍜', calories: 99, protein: 4.8, carbs: 21.5, fat: 0.4, fiber: 1.4, price: 1.6, primaryUnit: 'g', defaultQuantity: 150, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 12, name: '全麦馒头', emoji: '⚪', calories: 233, protein: 8.5, carbs: 48.7, fat: 1.1, fiber: 3.2, price: 0.7, primaryUnit: '个', defaultQuantity: 1, servingSize: 80, units: [{name: '个', rate: 80}, {name: 'g', rate: 1}] },
    ],
    蛋白质: [
        { id: 21, name: '鸡胸肉(水煮)', emoji: '🍗', calories: 165, protein: 31, carbs: 0, fat: 3.6, fiber: 0, price: 1.8, primaryUnit: 'g', defaultQuantity: 100, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 22, name: '鸡胸肉(煎)', emoji: '🍗', calories: 195, protein: 30, carbs: 0, fat: 7.8, fiber: 0, price: 1.9, primaryUnit: 'g', defaultQuantity: 100, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 23, name: '去皮鸡腿肉(烤)', emoji: '🍖', calories: 181, protein: 24, carbs: 0, fat: 8.2, fiber: 0, price: 1.5, primaryUnit: 'g', defaultQuantity: 100, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 24, name: '牛里脊(煎)', emoji: '🥩', calories: 182, protein: 29.2, carbs: 0, fat: 6.8, fiber: 0, price: 4.5, primaryUnit: 'g', defaultQuantity: 100, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 25, name: '牛腩(炖)', emoji: '🍲', calories: 220, protein: 26, carbs: 0, fat: 12, fiber: 0, price: 3.8, primaryUnit: 'g', defaultQuantity: 100, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 26, name: '瘦猪肉(炒)', emoji: '🥓', calories: 260, protein: 22, carbs: 1.2, fat: 18, fiber: 0, price: 2.0, primaryUnit: 'g', defaultQuantity: 100, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 27, name: '三文鱼(煎)', emoji: '🐟', calories: 208, protein: 20, carbs: 0, fat: 13, fiber: 0, price: 6.8, primaryUnit: 'g', defaultQuantity: 100, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 28, name: '水煮蛋', emoji: '🥚', calories: 77, protein: 6.3, carbs: 0.6, fat: 5.3, fiber: 0, price: 1.2, primaryUnit: '个', defaultQuantity: 1, servingSize: 50, units: [{name: '个', rate: 50}, {name: 'g', rate: 1}] },
        { id: 29, name: '煎蛋', emoji: '🍳', calories: 98, protein: 6.5, carbs: 0.6, fat: 7.7, fiber: 0, price: 1.3, primaryUnit: '个', defaultQuantity: 1, servingSize: 50, units: [{name: '个', rate: 50}, {name: 'g', rate: 1}] },
        { id: 30, name: '鳕鱼(蒸)', emoji: '🐡', calories: 105, protein: 22, carbs: 0, fat: 1.7, fiber: 0, price: 4.2, primaryUnit: 'g', defaultQuantity: 100, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 31, name: '虾仁(水煮)', emoji: '🦐', calories: 99, protein: 20.3, carbs: 0.8, fat: 1.2, fiber: 0, price: 5.0, primaryUnit: 'g', defaultQuantity: 100, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 32, name: '扇贝(熟)', emoji: '🦪', calories: 112, protein: 20.5, carbs: 3.9, fat: 1.4, fiber: 0, price: 6.5, primaryUnit: 'g', defaultQuantity: 100, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 33, name: '鹰嘴豆(熟)', emoji: '🧆', calories: 164, protein: 8.9, carbs: 27.4, fat: 2.6, fiber: 7.6, price: 1.5, primaryUnit: 'g', defaultQuantity: 100, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 34, name: '水浸金枪鱼罐头', emoji: '🐠', calories: 116, protein: 25.5, carbs: 0, fat: 0.8, fiber: 0, price: 5.5, primaryUnit: 'g', defaultQuantity: 90, servingSize: 100, units: [{name: 'g', rate: 1}] },
    ],
    蔬菜: [
        { id: 41, name: '西兰花(水煮)', emoji: '🥦', calories: 35, protein: 2.4, carbs: 7.2, fat: 0.4, fiber: 2.6, price: 0.8, primaryUnit: 'g', defaultQuantity: 150, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 42, name: '生菜', emoji: '🥬', calories: 15, protein: 1.4, carbs: 2.9, fat: 0.2, fiber: 1.3, price: 0.5, primaryUnit: 'g', defaultQuantity: 100, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 43, name: '番茄', emoji: '🍅', calories: 20, protein: 0.9, carbs: 3.9, fat: 0.2, fiber: 1.2, price: 0.6, primaryUnit: '个', defaultQuantity: 1, servingSize: 150, units: [{name: '个', rate: 150}, {name: 'g', rate: 1}] },
        { id: 44, name: '黄瓜', emoji: '🥒', calories: 16, protein: 0.7, carbs: 3.6, fat: 0.1, fiber: 0.5, price: 0.4, primaryUnit: '根', defaultQuantity: 1, servingSize: 150, units: [{name: '根', rate: 150}, {name: 'g', rate: 1}] },
        { id: 45, name: '胡萝卜(生)', emoji: '🥕', calories: 41, protein: 0.9, carbs: 9.6, fat: 0.2, fiber: 2.8, price: 0.4, primaryUnit: '根', defaultQuantity: 1, servingSize: 100, units: [{name: '根', rate: 100}, {name: 'g', rate: 1}] },
        { id: 46, name: '菠菜(水煮)', emoji: '🥬', calories: 23, protein: 2.9, carbs: 3.6, fat: 0.3, fiber: 2.2, price: 0.6, primaryUnit: 'g', defaultQuantity: 150, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 47, name: '芦笋(水煮)', emoji: '🌱', calories: 22, protein: 2.4, carbs: 4.1, fat: 0.2, fiber: 2.1, price: 1.2, primaryUnit: 'g', defaultQuantity: 100, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 48, name: '甜椒(青)', emoji: '🫑', calories: 20, protein: 0.9, carbs: 4.6, fat: 0.2, fiber: 1.7, price: 0.5, primaryUnit: '个', defaultQuantity: 1, servingSize: 120, units: [{name: '个', rate: 120}, {name: 'g', rate: 1}] },
        { id: 49, name: '茄子(蒸)', emoji: '🍆', calories: 35, protein: 1, carbs: 8.7, fat: 0.2, fiber: 2.5, price: 0.5, primaryUnit: 'g', defaultQuantity: 200, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 50, name: '蘑菇(炒)', emoji: '🍄', calories: 40, protein: 3.1, carbs: 4.3, fat: 2.0, fiber: 1.2, price: 1.0, primaryUnit: 'g', defaultQuantity: 100, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 51, name: '羽衣甘蓝', emoji: '🥬', calories: 35, protein: 2.9, carbs: 4.4, fat: 0.4, fiber: 4.1, price: 1.5, primaryUnit: 'g', defaultQuantity: 100, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 52, name: '海带', emoji: '🌿', calories: 16, protein: 1.7, carbs: 3.0, fat: 0.1, fiber: 1.3, price: 0.8, primaryUnit: 'g', defaultQuantity: 100, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 53, name: '金针菇', emoji: '🍄', calories: 37, protein: 2.7, carbs: 7.8, fat: 0.3, fiber: 2.7, price: 1.1, primaryUnit: 'g', defaultQuantity: 100, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 54, name: '黄豆芽(水煮)', emoji: '🌱', calories: 44, protein: 5.6, carbs: 4.2, fat: 1.3, fiber: 2.0, price: 0.3, primaryUnit: 'g', defaultQuantity: 100, servingSize: 100, units: [{name: 'g', rate: 1}] },
    ],
    水果: [
        { id: 61, name: '苹果', emoji: '🍎', calories: 52, protein: 0.3, carbs: 13.8, fat: 0.2, fiber: 2.4, price: 0.8, primaryUnit: '个', defaultQuantity: 1, servingSize: 200, units: [{name: '个', rate: 200}, {name: 'g', rate: 1}] },
        { id: 62, name: '香蕉', emoji: '🍌', calories: 89, protein: 1.1, carbs: 22.8, fat: 0.3, fiber: 2.6, price: 0.6, primaryUnit: '根', defaultQuantity: 1, servingSize: 120, units: [{name: '根', rate: 120}, {name: 'g', rate: 1}] },
        { id: 63, name: '蓝莓', emoji: '🫐', calories: 57, protein: 0.7, carbs: 14.5, fat: 0.3, fiber: 2.4, price: 4.0, primaryUnit: 'g', defaultQuantity: 50, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 64, name: '草莓', emoji: '🍓', calories: 32, protein: 0.7, carbs: 7.7, fat: 0.3, fiber: 2.0, price: 2.0, primaryUnit: 'g', defaultQuantity: 100, servingSize: 100, units: [{name: 'g', rate: 1}, {name: '颗', rate: 15}] },
        { id: 65, name: '牛油果', emoji: '🥑', calories: 160, protein: 2, carbs: 8.5, fat: 14.7, fiber: 6.7, price: 3.5, primaryUnit: '个', defaultQuantity: 1, servingSize: 150, units: [{name: '个', rate: 150}, {name: 'g', rate: 1}] },
        { id: 66, name: '橙子', emoji: '🍊', calories: 47, protein: 0.9, carbs: 11.8, fat: 0.1, fiber: 2.4, price: 0.8, primaryUnit: '个', defaultQuantity: 1, servingSize: 180, units: [{name: '个', rate: 180}, {name: 'g', rate: 1}] },
        { id: 67, name: '葡萄', emoji: '🍇', calories: 69, protein: 0.7, carbs: 18.1, fat: 0.2, fiber: 0.9, price: 1.5, primaryUnit: 'g', defaultQuantity: 100, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 68, name: '西瓜', emoji: '🍉', calories: 30, protein: 0.6, carbs: 7.6, fat: 0.2, fiber: 0.4, price: 0.4, primaryUnit: 'g', defaultQuantity: 200, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 69, name: '奇异果', emoji: '🥝', calories: 61, protein: 1.1, carbs: 14.7, fat: 0.5, fiber: 3.0, price: 1.5, primaryUnit: '个', defaultQuantity: 1, servingSize: 80, units: [{name: '个', rate: 80}, {name: 'g', rate: 1}] },
        { id: 70, name: '西柚', emoji: '🍊', calories: 42, protein: 0.8, carbs: 10.7, fat: 0.1, fiber: 1.6, price: 1.1, primaryUnit: '个', defaultQuantity: 1, servingSize: 250, units: [{name: '个', rate: 250}, {name: 'g', rate: 1}] },
    ],
    奶制品与豆制品: [
        { id: 81, name: '全脂牛奶', emoji: '🥛', calories: 61, protein: 3.2, carbs: 4.8, fat: 3.3, fiber: 0, price: 1.0, primaryUnit: 'ml', defaultQuantity: 250, servingSize: 100, units: [{name: 'ml', rate: 1}, {name: '杯', rate: 250}] },
        { id: 82, name: '脱脂牛奶', emoji: '🥛', calories: 35, protein: 3.4, carbs: 5.0, fat: 0.1, fiber: 0, price: 1.2, primaryUnit: 'ml', defaultQuantity: 250, servingSize: 100, units: [{name: 'ml', rate: 1}, {name: '杯', rate: 250}] },
        { id: 83, name: '无糖豆浆', emoji: '🥛', calories: 31, protein: 3.0, carbs: 1.1, fat: 1.6, fiber: 1.0, price: 0.8, primaryUnit: 'ml', defaultQuantity: 250, servingSize: 100, units: [{name: 'ml', rate: 1}, {name: '杯', rate: 250}] },
        { id: 84, name: '北豆腐(老)', emoji: '🧱', calories: 98, protein: 10.3, carbs: 3.8, fat: 4.4, fiber: 0.8, price: 0.6, primaryUnit: '块', defaultQuantity: 1, servingSize: 100, units: [{name: '块', rate: 100}, {name: 'g', rate: 1}] },
        { id: 85, name: '南豆腐(嫩)', emoji: '🍮', calories: 57, protein: 6.2, carbs: 2.1, fat: 2.7, fiber: 0.3, price: 0.5, primaryUnit: '盒', defaultQuantity: 1, servingSize: 150, units: [{name: '盒', rate: 150}, {name: 'g', rate: 1}] },
        { id: 86, name: '豆腐干', emoji: '🟫', calories: 140, protein: 17, carbs: 4.9, fat: 5.8, fiber: 1.2, price: 0.8, primaryUnit: '块', defaultQuantity: 1, servingSize: 50, units: [{name: '块', rate: 50}, {name: 'g', rate: 1}] },
        { id: 87, name: '原味酸奶', emoji: '🍦', calories: 62, protein: 3.5, carbs: 4.7, fat: 3.3, fiber: 0, price: 1.2, primaryUnit: '杯', defaultQuantity: 1, servingSize: 200, units: [{name: '杯', rate: 200}, {name: 'ml', rate: 1}] },
        { id: 88, name: '希腊酸奶(原味)', emoji: '🇬🇷', calories: 97, protein: 17, carbs: 6, fat: 0.7, fiber: 0, price: 2.5, primaryUnit: 'g', defaultQuantity: 100, servingSize: 100, units: [{name: 'g', rate: 1}, {name: '杯', rate: 200}] },
        { id: 89, name: '茅屋奶酪(低脂)', emoji: '🧀', calories: 72, protein: 11, carbs: 3.4, fat: 1.0, fiber: 0, price: 3.0, primaryUnit: 'g', defaultQuantity: 100, servingSize: 100, units: [{name: 'g', rate: 1}] },
    ],
    坚果与种子: [
        { id: 91, name: '杏仁', emoji: '🌰', calories: 579, protein: 21.2, carbs: 21.6, fat: 49.9, fiber: 12.5, price: 5.8, primaryUnit: 'g', defaultQuantity: 15, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 92, name: '核桃', emoji: '🧠', calories: 654, protein: 15.2, carbs: 13.7, fat: 65.2, fiber: 6.7, price: 6.5, primaryUnit: 'g', defaultQuantity: 20, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 93, name: '腰果', emoji: '🥜', calories: 553, protein: 18.2, carbs: 30.2, fat: 43.9, fiber: 3.3, price: 5.5, primaryUnit: 'g', defaultQuantity: 15, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 94, name: '花生', emoji: '🥜', calories: 567, protein: 25.8, carbs: 16.1, fat: 49.2, fiber: 8.5, price: 3.0, primaryUnit: 'g', defaultQuantity: 15, servingSize: 100, units: [{name: 'g', rate: 1}] },
        { id: 95, name: '奇亚籽', emoji: '⚫', calories: 486, protein: 16.5, carbs: 42.1, fat: 30.7, fiber: 34.4, price: 4.0, primaryUnit: 'g', defaultQuantity: 10, servingSize: 100, units: [{name: 'g', rate: 1}, {name: '勺', rate: 10}] },
        { id: 96, name: '亚麻籽粉', emoji: '🟤', calories: 534, protein: 18.3, carbs: 28.9, fat: 42.2, fiber: 27.3, price: 3.5, primaryUnit: 'g', defaultQuantity: 10, servingSize: 100, units: [{name: 'g', rate: 1}, {name: '勺', rate: 10}] },
    ],
    酱料与油脂: [
        { id: 101, name: '橄榄油', emoji: '🫒', calories: 884, protein: 0, carbs: 0, fat: 100, fiber: 0, price: 3.5, primaryUnit: 'g', defaultQuantity: 10, servingSize: 100, units: [{name: 'g', rate: 1}, {name: '勺', rate: 10}] },
        { id: 102, name: '酱油(生抽)', emoji: '🥫', calories: 53, protein: 7.9, carbs: 5.2, fat: 0.1, fiber: 0.3, price: 0.8, primaryUnit: 'ml', defaultQuantity: 10, servingSize: 100, units: [{name: 'ml', rate: 1}, {name: '勺', rate: 10}] },
        { id: 103, name: '醋(米醋)', emoji: '🧴', calories: 31, protein: 0.4, carbs: 6.9, fat: 0, fiber: 0, price: 0.6, primaryUnit: 'ml', defaultQuantity: 10, servingSize: 100, units: [{name: 'ml', rate: 1}, {name: '勺', rate: 10}] },
        { id: 104, name: '番茄酱(无糖)', emoji: '🍅', calories: 82, protein: 3.8, carbs: 18.9, fat: 0.3, fiber: 3.0, price: 1.2, primaryUnit: 'g', defaultQuantity: 15, servingSize: 100, units: [{name: 'g', rate: 1}, {name: '勺', rate: 15}] },
        { id: 105, name: '芝麻酱', emoji: '🥣', calories: 630, protein: 21, carbs: 23, fat: 55, fiber: 8, price: 3.0, primaryUnit: 'g', defaultQuantity: 15, servingSize: 100, units: [{name: 'g', rate: 1}, {name: '勺', rate: 15}] },
        { id: 106, name: '是拉差辣椒酱', emoji: '🌶️', calories: 75, protein: 1.7, carbs: 16.7, fat: 0, fiber: 0, price: 1.8, primaryUnit: 'g', defaultQuantity: 10, servingSize: 100, units: [{name: 'g', rate: 1}, {name: '勺', rate: 5}] },
        { id: 107, name: '盐', emoji: '🧂', calories: 0, protein: 0, carbs: 0, fat: 0, fiber: 0, price: 0.2, primaryUnit: 'g', defaultQuantity: 1, servingSize: 100, units: [{name: 'g', rate: 1}] },
    ],
    健康饮品: [
        { id: 111, name: '蛋白粉(每勺)', emoji: '💪', calories: 120, protein: 24, carbs: 3, fat: 1.5, fiber: 1, price: 4.0, primaryUnit: '勺', defaultQuantity: 1, servingSize: 30, units: [{name: '勺', rate: 30}, {name: 'g', rate: 1}] },
        { id: 112, name: '黑咖啡', emoji: '☕', calories: 2, protein: 0.3, carbs: 0, fat: 0, fiber: 0, price: 0.8, primaryUnit: '杯', defaultQuantity: 1, servingSize: 250, units: [{name: '杯', rate: 250}, {name: 'ml', rate: 1}] },
        { id: 113, name: '无糖茶饮', emoji: '🍵', calories: 1, protein: 0.2, carbs: 0, fat: 0, fiber: 0, price: 0.5, primaryUnit: '杯', defaultQuantity: 1, servingSize: 250, units: [{name: '杯', rate: 250}, {name: 'ml', rate: 1}] },
        { id: 114, name: '柠檬水(无糖)', emoji: '🍋', calories: 4, protein: 0.1, carbs: 1.1, fat: 0, fiber: 0.1, price: 0.3, primaryUnit: '杯', defaultQuantity: 1, servingSize: 250, units: [{name: '杯', rate: 250}, {name: 'ml', rate: 1}] },
    ],
};
